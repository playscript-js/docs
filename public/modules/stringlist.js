class stringlist extends tag{
  ...
  push(obj,pos,rep){
    ...
    title=obj.title?new text(obj.title,null,null,"oneline").css({"color":"var(--text)","font-size":obj.body?"17px":"17px","padding":"3px"}):""
    body=obj.body?new text(obj.body,null,null,"oneline").css({padding:"3px",opacity:.5}):""
  ...
  hashtrue(){
    ...
    this.call(m.index()+1,this.listdata[m.index()+1],m,this.list())
    m={}
  }
