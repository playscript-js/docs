...
theme(type){
  ...
  if(type=="light"){
    window.localStorage.play_back="#fcfcfc";window.localStorage.play_text="#545454";window.localStorage.play_shadow="#00000010";
    html.cssvar({text:window.localStorage.play_text,back:window.localStorage.play_back,shadow:window.localStorage.play_shadow})

  }else {
  window.localStorage.play_back="#161616";window.localStorage.play_text="#ececec";window.localStorage.play_shadow="#00000040";
  html.cssvar({text:window.localStorage.play_text,back:window.localStorage.play_back,shadow:window.localStorage.play_shadow})
